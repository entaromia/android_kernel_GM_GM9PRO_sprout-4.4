...
#include "include/sec_cmd.h" // <linux/input/sec_cmd.h>
...
#define SEC_TS_CMD_SW_RESET			0x42 /* only y661  (y761:0x12) */
...
#define SEC_TS_DEBUG_PRINT_ALLEVENT	0x1
#define SEC_TS_DEBUG_PRINT_ONEEVENT	0x2
